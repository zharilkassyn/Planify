...
const NAV = [
  ...
  { label: 'ИИ-помощник', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="7" width="14" height="13" rx="3"/><path d="M9 7V4"/><path d="M15 7V4"/><path d="M8 12h.01"/><path d="M16 12h.01"/><path d="M9 16h6"/><path d="M3 13h2"/><path d="M19 13h2"/></svg> },
  ...
  { label: 'Генерация презентаций', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/><line x1="7" y1="8" x2="15" y2="8"/><line x1="7" y1="12" x2="11" y2="12"/></svg> },
  { label: 'Игры', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><line x1="15" y1="13" x2="15.01" y2="13"/><line x1="18" y1="11" x2="18.01" y2="11"/><path d="M5.4 18.6A3.5 3.5 0 011 15.2l1.2-6.1A5 5 0 017.1 5h9.8a5 5 0 014.9 4.1l1.2 6.1a3.5 3.5 0 01-4.4 3.4l-2.7-.8H8.1z"/></svg> },
];
  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
        {activeNav === 'Планировщик' ? <Planner /> : activeNav === 'Таймер' ? <TimerPage /> : activeNav === 'ИИ-помощник' ? <AIPage onNavigate={setActiveNav} /> : activeNav === 'Флеш-карты' ? <FlashCards /> : activeNav === 'Заметки' ? <NotesPage /> : activeNav === 'Игры' ? <GamesPage /> : activeNav === 'Генерация презентаций' ? <PresentationsPage /> : activeNav === 'Настройки' ? <SettingsPage displayName={displayName} email={email} onNameChange={setDisplayName} avatarColor={avatarColor} onAvatarColorChange={handleAvatarColor} avatarImg={avatarImg} onAvatarImgChange={handleAvatarImg} theme={theme} onThemeChange={handleThemeChange} /> : <Entries userEmail={displayName} onNavigate={setActiveNav} />}
      </main>
    </div>
  );
}
